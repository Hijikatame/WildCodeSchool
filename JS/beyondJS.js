...
const instructorJS = instructors.filter(instructor => instructor.specialities.includes('Javascript') && instructor.availability === 'all');

console.log(instructorJS);

instructorJS.forEach(instructor => {
